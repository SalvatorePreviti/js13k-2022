...
export const buildWorld = () => {
  ...
  newModel(() => {
    newSoul(identity.translate(0, 3, 10), [[0, 0, 7]]);
          ...
          csg_polygons(
            csg_subtract(
              csg_union(
                polygons_transform(
                  cylinder(GQuad),
                  identity.translate(0, 0, -30).scale(1.5, 1, 5),
              ...
              polygons_transform(
                cylinder(GQuad),
                identity.translate(0, 0, -30).scale(1.3, 10, 1.3),
                material(0.2, 0.7, 0.4, 0.6),
              ),
            ),
          ),
        );
        ...
        meshAdd(
          csg_polygons(
            csg_subtract(
              ...
              polygons_transform(
                cylinder(GQuad),
                identity.translate(-27, -3, -20).scale(1, 3, 1),
                material(0.9, 0.9, 0.9, 0.2),
              ),
            ),
          ),
      ...
      meshAdd(
        csg_polygons(
          csg_subtract(
            polygons_transform(
              cylinder(GQuad),
              identity.translate(-100, 1, -12).scale(7.5, 4, 1),
      ...
      withEditMatrix(identity.translate(-38.9, -11.3, -51), () => {
        meshAdd(
          csg_polygons(
            csg_subtract(
              csg_union(
                polygons_transform(cylinder(GQuad), identity.scale(11, 1, 8), material(0.3, 0.4, 0.6, 0.3)),
